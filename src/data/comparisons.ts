...
export const comparisons: CompetitorComparison[] = [
  {
    ...
    matrix: [
      ...
      { feature: "Vertical actors (Amazon, Zillow, Maps)", them: "Generic scrape", us: "Dedicated extractors" },
  ...
  },
  {
    ...
    whereWeGoFurther: [
      ...
      "**Vertical actors.** Amazon, Zillow, and Google Maps return structured product, property, and place data. ScraperAPI returns raw HTML and leaves parsing to you.",
    ...
    matrix: [
      ...
      { feature: "Vertical actors (Amazon, Zillow, Maps)", them: "Raw HTML only", us: "Structured JSON" },
  ...
  },
  {
    ...
    matrix: [
      ...
      { feature: "Domain intelligence (DNS/WHOIS/SSL)", them: "Not offered", us: "Included" },
      { feature: "Vertical actors (Amazon, Zillow, Maps)", them: "Site templates", us: "Dedicated extractors" },
  ...
  },
  {
    ...
    matrix: [
      ...
      { feature: "Browser automation (sessions + NL actions)", them: "Not offered", us: "Included" },
      { feature: "Vertical actors (Amazon, Zillow, Maps)", them: "Via extraction", us: "Dedicated extractors" },
      { feature: "MCP server for AI agents", them: "Not offered", us: "Included" },
      { feature: "Free to start", them: "Trial", us: "1,000 credits" },
    ],
  ...
  },
  {
    ...
    matrix: [
      ...
      { feature: "Domain intelligence (DNS/WHOIS/SSL)", them: "Not offered", us: "Included" },
      { feature: "Vertical actors (Amazon, Zillow, Maps)", them: "Not offered", us: "Dedicated extractors" },
      { feature: "MCP server for AI agents", them: "Not offered", us: "Included" },
      { feature: "Free to start", them: "Trial credits", us: "1,000 credits" },
    ],
  ...
  },
  {
    ...
    matrix: [
      ...
      { feature: "Clean markdown output for LLMs", them: "Not native", us: "Native" },
      { feature: "Domain intelligence (DNS / WHOIS / SSL)", them: "Not offered", us: "Included" },
      { feature: "Vertical actors (Amazon, Zillow, Maps)", them: "Per-robot", us: "Dedicated extractors" },
      { feature: "MCP server for AI agents", them: "Not offered", us: "Included" },
      { feature: "Free to start", them: "Free plan", us: "1,000 credits" },
    ],
